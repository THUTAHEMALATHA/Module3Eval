...
function Sidebar({ onAdd, onFilter, onSearch }) {
  ...
  const handleAdd = (e) => {
    ...
    if (!payload.name || !payload.image) return alert("Fill all fields");
    onAdd(payload);
    e.target.reset();
  };
    ...
    <div>
      ...
      <form onSubmit={handleAdd}>
        ...
        <input
          name="image"
          type="Image"
          placeholder="https://coding-platform.s3.amazonaws.com/dev/lms/tickets/7524df6e-46fa-4506-8766-eca8da47c2f1/2izhqnTaNLdenHYF.jpeg"
        />
      </form>
    </div>
  );
